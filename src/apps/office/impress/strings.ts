...
defineStrings('impress', {
  ar: {
    ...
    'masterFooter': 'التذييل',
    'masterFooterHint': 'نصّ يظهر أسفل كل شريحة — اتركه فارغًا لإخفائه.',
    'masterSlideNumber': 'رقم الشريحة',
    'masterSlideNumberHint': 'رقم حيّ يتغيّر في PowerPoint إذا أُضيفت شريحة قبله.',
    'diagrams': 'مخطط',
    'diagramList': 'قائمة',
  ...
  en: {
    ...
    'masterFooter': 'Footer',
    'masterFooterHint': 'Text shown at the foot of every slide — leave it empty to hide it.',
    'masterSlideNumber': 'Slide number',
    'masterSlideNumberHint': 'A live number: it changes in PowerPoint when a slide is inserted before it.',
    'diagrams': 'Diagram',
    'diagramList': 'List',

...
export const FALLBACK_DESCRIPTIONS: Record<string, LocalizedText> = {
  ...
  'org.faisal.Claude': { ar: 'وكيل ذكي عبر GroqCloud يدير ملفاتك وتطبيقاتك وينفّذ الأوامر بإذنك', en: 'An AI agent on GroqCloud that manages your files and apps and runs commands, with your OK' },

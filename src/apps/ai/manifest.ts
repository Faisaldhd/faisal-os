...
export const manifest: AppManifest = {
  ...
  description: {
    ar: 'وكيل ذكي عبر GroqCloud أو DeepSeek بمفتاحك الخاص: يدير ملفاتك وتطبيقاتك وينفّذ الأوامر بإذنك',
    en: 'An AI agent on GroqCloud or DeepSeek with your own key: it manages your files and apps and runs commands, with your OK',
  },
  icon: ICON_AI,

...
| `org.faisal.Claude` | Faisal AI / Faisal AI | utilities | `network`, `fs:home`, `fs:read-all`, `system:monitor`, `settings`, `notifications` | single | Groq-backed agent that proposes file, app and shell actions; every change asks for confirmation |
